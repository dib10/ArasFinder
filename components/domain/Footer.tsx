  ...
  return (
    <footer className="mt-8 text-center py-6 border-t border-gray-200 dark:border-gray-700">
      <nav className="flex justify-center gap-4 sm:gap-6 mb-4 flex-wrap">
        ...
        <Link href="/privacy" className="text-sm text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200">Política de Privacidade</Link>
        <Link href="/contact" className="text-sm text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200">Contato</Link>
      </nav>
    </footer>
  )
}
